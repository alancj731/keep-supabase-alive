...
public class DriverManagerConnectionFactory implements JdbcConnectionFactory {
    ...
    public Connection open(SupabaseProject project) throws SQLException {
        ...
        // Transaction poolers reuse server sessions across clients. Simple query mode creates no
        // named prepared statements that could survive one client and collide with the next.
